                ...
                .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(backgroundLayout.createSequentialGroup()
                        .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(labelBinario, javax.swing.GroupLayout.DEFAULT_SIZE, 73, Short.MAX_VALUE)
                            .addComponent(labelMIPS))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(backgroundLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(backgroundLayout.createSequentialGroup()
                                .addComponent(jTextTipo, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (jRadioBinToMIPS.isSelected()) {
            ...
            if (opcode.equals("000000")) {
                ...
                if (opcode.equals("000010") || opcode.equals("000011")) {
                    jTextMIPS.setText(instrJ(opcode, codigoBinario));
                    jTextTipo.setText("J");
                }
                    ...
                    switch(opcode) {
                        case "001000":
                            jTextMIPS.setText(instrItype1("addi", rt, rs, immediate));
                            jTableRegistradores.setValueAt(opAddi(rs, immediate), converteReg(rt), 1);
                            break;
                        case "001001":
                            jTextMIPS.setText(instrItype1("addiu", rt, rs, immediate));
                            break;
                        case "001100":
                            jTextMIPS.setText(instrItype1("andi", rt, rs, immediate));
                            break;
                        case "000100":
                            jTextMIPS.setText(instrItype1("beq", rs, rt, immediate));
                            break;
                        case "000001":
                            if (rt.equals("00001")) {
                                jTextMIPS.setText(instrItype2("bgez", rs, immediate));
                            }
                        ...
                        case "000111":
                            if (rt.equals("00000")) {
                                jTextMIPS.setText(instrItype2("bgtz", rs, immediate));
                            }
                            else {
                                jTextMIPS.setText("Erro: Instrução do Tipo I inválida");
                            }
                        ...
                        case "000110":
                            if (rt.equals("00000")) {
                                jTextMIPS.setText(instrItype2("blez", rs, immediate));
                            }
                            else {
                                jTextMIPS.setText("Erro: Instrução do Tipo I inválida");
                            }
                        ...
                        /*case "000001":
                            ...
                            break;*/
                        case "000101":
                            jTextMIPS.setText(instrItype1("bne", rs, rt, immediate));
                            break;
                        case "100000":
                            jTextMIPS.setText(instrItype3("lb", rt, immediate, rs));
                            break;
                        case "100100":
                            jTextMIPS.setText(instrItype3("lbu", rt, immediate, rs));
                            break;
                        case "100001":
                            jTextMIPS.setText(instrItype3("lh", rt, immediate, rs));
                            break;
                        case "100101":
                            jTextMIPS.setText(instrItype3("lhu", rt, immediate, rs));
                            break;
                        case "001111":
                            jTextMIPS.setText("lui " + "$" + rt + " $" + immediate);
                            break;
                        case "100011":
                            jTextMIPS.setText(instrItype3("lw", rt, immediate, rs));
                            break;
                        case "110001":
                            jTextMIPS.setText(instrItype3("lwel", rt, immediate, rs));
                            break;
                        case "001101":
                            jTextMIPS.setText(instrItype1("ori", rt, rs, immediate));
                            break;
                        case "101000":
                            jTextMIPS.setText(instrItype3("sb", rt, immediate, rs));
                            break;
                        case "001010":
                            jTextMIPS.setText(instrItype1("slti", rt, rs, immediate));
                            break;
                        case "001011":
                            jTextMIPS.setText(instrItype1("sltiu", rt, rs, immediate));
                            break;
                        case "101001":
                            jTextMIPS.setText(instrItype3("sh", rt, immediate, rs));
                            break;
                        case "101011":
                            jTextMIPS.setText(instrItype3("sw", rt, immediate, rs));
                            break;
                        case "111001":
                            jTextMIPS.setText(instrItype3("swel", rt, immediate, rs));
                            break;
                        case "001110":
                            jTextMIPS.setText(instrItype1("xori", rt, rs, immediate));
                            break;
                    }
                }
                else {
