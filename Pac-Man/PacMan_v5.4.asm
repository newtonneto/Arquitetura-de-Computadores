.text
	...
	#$19 Recebe direção pac-man: 0 - direita 1 - esquerda 2 - cima 3 - baixo
	#$20 Fantasma 1 - Rosa
	#$21 Fantasma 2 - Amarelo
	#$22 Fantasma 3 - Verde
	#$23 Fantasma 4 - Vermelho
	#$24 Recebe o input do teclado
	#$25 Recebe a tecla digitada
	#$26 Pac-Man
...
inicializacao:
	...
	addi $26, $0, 2580 #Posição inicial do Pac-Man
	lui $24, 0xffff #Recebe o input do teclado
...
movePacMan:
	...
	add $17, $0, $31
	#Verifica se alguma teclado foi digitada
	lw $25, 0($24)
	beq $25, 0, cancelMove #Primeiro verifica se algo foi digitado, se receber 1 é por que algo foi digitado, 0 se não
	lw $25, 4($24) #Armazena em $25 a tecla digitada
	
	#Movimenta o Pac-Man com base na letra digitada
	beq $25, 100, direita0
	beq $25, 97, esquerda0
	beq $25, 119, cima0
	beq $25, 115, baixo0
...
direita0:
	#Inicia o processo de verificação de colisão, que consiste em verificar os 9 pixels a direita, esquerda, em cima ou em baixo do pac-man, dependendo da direção seguida por ele
	addi $11, $0, 0
	lui $8, 0x1001
	add $8, $8, $26 #Adiciona a posição atual do pac-man ao calculo
	add $8, $8, -2028 #Adiciona a posição do 1° dos 9 pixels a serem verificados
verificaColisao1:
	beq $11, 9, fimVer1 #For para incrementar os pixels verificados
	lw $12, 0($8) #Recebe o pixel a ser verificado
	beq $12, 0x0000FF, cancelMove #Caso seja encontrado a cor azul no pixel o movimento é cancelado
	addi $11, $11, 1 #Incrementa o indice do for
	addi $8, $8, 512 #Incrementa o pixel
	j verificaColisao1
	#Caso passe pela verificação o movimento será realizado
fimVer1:lui $8, 0x1001
	jal apagaPacMan
	add $26, $26, 4
	jal pacMan
...
esquerda0:
	...
	lui $8, 0x1001
	add $8, $8, $26 #Adiciona a posição atual do pac-man ao calculo
	add $8, $8, -2068 #Adiciona a posição do 1° dos 9 pixels a serem verificados
verificaColisao2:
	beq $11, 9, fimVer2 #For para incrementar os pixels verificados
	lw $12, 0($8) #Recebe o pixel a ser verificado
	beq $12, 0x0000FF, cancelMove #Caso seja encontrado a cor azul no pixel o movimento é cancelado
	addi $11, $11, 1 #Incrementa o indice do for
	addi $8, $8, 512 #Incrementa o pixel
...
cima0:
	...
	lui $8, 0x1001
	add $8, $8, $26 #Adiciona a posição atual do pac-man ao calculo
	add $8, $8, -2576 #Adiciona a posição do 1° dos 9 pixels a serem verificados
verificaColisao3:
	beq $11, 9, fimVer3 #For para incrementar os pixels verificados
	lw $12, 0($8) #Recebe o pixel a ser verificado
	beq $12, 0x0000FF, cancelMove #Caso seja encontrado a cor azul no pixel o movimento é cancelado
	addi $11, $11, 1 #Incrementa o indice do for
	addi $8, $8, 4 #Incrementa o pixel
	j verificaColisao3
	#Caso passe pela verificação o movimento será realizado
fimVer3:lui $8, 0x1001
	jal apagaPacMan
	add $26, $26, -512
	jal pacMan
...
baixo0:
	...
	lui $8, 0x1001
	add $8, $8, $26 #Adiciona a posição atual do pac-man ao calculo
	add $8, $8, 2544 #Adiciona a posição do 1° dos 9 pixels a serem verificados
verificaColisao4:
	beq $11, 9, fimVer4 #For para incrementar os pixels verificados
	lw $12, 0($8) #Recebe o pixel a ser verificado
	beq $12, 0x0000FF, cancelMove #Caso seja encontrado a cor azul no pixel o movimento é cancelado
	addi $11, $11, 1 #Incrementa o indice do for
	addi $8, $8, 4 #Incrementa o pixel
