...
script:
	...
	jal apagaGhost2
	add $21, $21, -512
	jal ghost2 #Ghost2 anda 1
	add $4, $0, $18
	addi $2, $0, 32
	syscall
	jal apagaGhost2
	add $21, $21, -512
	jal ghost2 #Ghost2 anda 2
	add $4, $0, $18
	addi $2, $0, 32
	syscall
	jal apagaGhost2
	add $21, $21, -512
	jal ghost2 #Ghost2 anda 3
	add $4, $0, $18
	addi $2, $0, 32
	syscall
	jal apagaGhost2
	add $21, $21, -512
	jal ghost2 #Ghost2 anda 4
	add $4, $0, $18
	addi $2, $0, 32
	syscall
	jal apagaGhost2
	add $21, $21, -512
	jal ghost2 #Ghost2 anda 5
	add $4, $0, $18
	addi $2, $0, 32
	syscall
	jal apagaGhost2
	add $21, $21, -512
	jal ghost2 #Ghost2 anda 6 <- O ghost1 (rosa) pode começar a se mover a partir do 6º movimento do ghost2 (amarelo)
	add $4, $0, $18
	addi $2, $0, 32
	syscall
	...
	jal apagaGhost1
	add $20, $20, -512
	jal ghost1 #Ghost1 anda 12 <- O ghost3 (verde) pode começar a se mover a partir do 12º movimento do ghost1 (rosa)
	add $4, $0, $18
	addi $2, $0, 32
	syscall
	...
	jal apagaGhost3
	add $22, $22, -4
	jal ghost3 #Ghost3 anda 6 <- O ghost4 (vermelho) pode começar a se mover a partir do 6º movimento do ghost3 (verde)
	add $4, $0, $18
	addi $2, $0, 32
	syscall
